...
from render import (
    ...
    _answer_head, _clean_catechism_footnote_spill,
    _remove_catechism_lookahead_ghosts, _remove_duplicate_catechism_answer_opening,
    _repair_known_front_matter_text, _repair_known_source_losses,
