...
* **Contexts:**
  * ... three ways revealed his will unto the prophets, — **1 .** By objects of their senses, as by audible voices; ...

### 2. `2dly .`
* **Description:** Spaced period (space before period)
* **Chapter:** *Chapter 3 - Corruption or Depravation of the Mind by Sin.*
* **Contexts:**
  * ... the commands of God: — 1st. That they are equal; **2dly .** That they are easy, or not grievous. The former ...
...
* **Chapter:** *Chapter 5 - the Nature, Causes, and Means of Regeneration.*
* **Contexts:**
  * ... objective allurement is not sufficient thereunto? **Ans .** It is acknowledged that in the work of conversion ...

### 5. `idem .`
* **Description:** Spaced period (space before period)
* **Chapter:** *Chapter 5 - the Nature, Causes, and Means of Regeneration.*
* **Contexts:**
  * ... o the will; for, — [1.] The opposition is not ad **idem .** The enmity and opposition that is acted by the wi ...

### 6. `2dly .`
* **Description:** Spaced period (space before period)
* **Chapter:** *Chapter 5 - the Nature, Causes, and Means of Regeneration.*
* **Contexts:**
  * ... itself unto any end whereunto it may be applied. **2dly .** An obstinate, stubborn opposition unto all things ...

### 7. `4thly .`
* **Description:** Spaced period (space before period)
* **Chapter:** *Chapter 5 - the Filth of Sin Purged by the Spirit*
* **Contexts:**
  * ... And this we are directed unto, Hebrews 4:15, 16. **4thly .** An acquiescency in the truth and faithfulness of ...

### 8. `habit .`
* **Description:** Spaced period (space before period)
* **Chapter:** *Chapter 6 - the Positive Work of the Spirit in the Sanctification of Believers.*
* **Contexts:**
  * ... se three things: — 1. Show what I mean by such a **habit .** 2. Prove that there is such a habit required unt ...

### 9. `3dly .`
* **Description:** Spaced period (space before period)
* **Chapter:** *Chapter 6 - the Positive Work of the Spirit in the Sanctification of Believers.*
* **Contexts:**
  * ... line the mind unto them and prepare it for them. **3dly .** It causeth the affections to cleave and adhere un ...

### 10. `Ans .`
* **Description:** Spaced period (space before period)
* **Chapter:** *Chapter 6 - the Positive Work of the Spirit in the Sanctification of Believers.*
* **Contexts:**
  * ... ve his Spirit, if thereby we are united to him." **Ans .** 1. If this be so, then indeed are we not beholden ...

### 11. `Assimilation :`
* **Description:** Spaced punctuation (space before character)
* **Chapter:** *Chapter 8 - Mortification of Sin, the Nature and Causes of It.*
* **Contexts:**
  * ... f all true love, are, first, Adherence; secondly, **Assimilation :** — (First,) Adherence. Love in the Scripture is fr ...

### 12. `2dly .`
* **Description:** Spaced period (space before period)
* **Chapter:** *Chapter 8 - Mortification of Sin, the Nature and Causes of It.*
* **Contexts:**
  * ... r unmeet habitations for the Holy Spirit of God. **2dly .** The manner of the actual operation of the Spirit ...

### 13. `transgression :`
* **Description:** Spaced punctuation (space before character)
* **Chapter:** *Chapter 3 - Holiness Necessary From the Commands of God.*
* **Contexts:**
  * ... ence the minds of men who are inclined unto their **transgression :** — [1.] The first is, that the rewards and punish ...

### 14. `free ;`
* **Description:** Spaced punctuation (space before character)
* **Chapter:** *Chapter 4 - Necessity of Holiness From God's Sending Jesus Christ.*
* **Contexts:**
  * ... uced unto these heads: — 1. To make his subjects **free ;** 2. To preserve them in safety, delivering their ...

### 15. `2dly .`
* **Description:** Spaced period (space before period)
* **Chapter:** *Chapter 4 - Necessity of Holiness From God's Sending Jesus Christ.*
* **Contexts:**
  * ... ave sufficiently proved in this whole discourse. **2dly .** Very few of the precepts of it are certain, so as ...

### 16. `n )`
* **Description:** Spaced closing parenthesis
* **Chapter:** *Chapter 4 - Necessity of Holiness From God's Sending Jesus Christ.*
* **Contexts:**
  * ... ure and the use of right reason (that is, their ow**n )** as their guide; and some add the additional docum ...

### 17. `sin :`
* **Description:** Spaced punctuation (space before character)
* **Chapter:** *Chapter 5 - Necessity of Holiness From Our Condition in This World.*
* **Contexts:**
  * ... bellious actings of the re mainders of indwelling **sin :** — (1.) In particular instances; (2.) In the who ...

### 18. `n )`
* **Description:** Spaced closing parenthesis
* **Chapter:** *Chapter 5 - Necessity of Holiness From Our Condition in This World.*
* **Contexts:**
  * ... nfusion of the minds of men and of the power of si**n )** do either proceed from them or are carried on by ...
...
* **Contexts:**
  * ... us Christ, there will not want sufficient testimon**y against** that putid figment of moral virtue being all our ...
