...
*   **`dense_source_window_loss`**: PDF pages `[3, 4, 5, 7, 10, 17, 19, 29, 34, 52, 75, 90, 102, 103, 106, 108, 115, 119, 126, 137, 138, 141, 145, 180, 188, 189, 200, 218, 219, 239, 245, 248, 250, 269, 271, 289, 293, 297, 300]`. These represent front matter, editor notes, title pages, lists of questions, or block references that don't map directly to consecutive body text paragraphs.
