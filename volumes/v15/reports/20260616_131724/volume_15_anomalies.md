# Text Integrity & Anomaly Audit Report: Volume 15
...
* **Total Words Audited:** 265576
* **Total Suspected Anomalies Found:** 1

Add corrections to `text_replacements` inside `volumes/v15/convert.py` to fix these.

## Summary by Category

* **Hyphenation Anomalies:** 0 items
* **Punctuation Spacing Blemishes:** 1 items
...
* **Chapter:** *The Preface.*
* **Contexts:**
  * ... solam, unicam, ecclesiae pacem esse, quae Christi **est ,**" saith Hilary. Suppose that men retain a form of ...
