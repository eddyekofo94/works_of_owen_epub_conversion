...
* e.g., `Sabbath-breaker`, `evil-doer`, `top-stone`, `eye-salve`, `under-propping`, `stout-hearted`, `shittim-wood`. All 43 items in the JSON whitelist have been verified against the print edition.
