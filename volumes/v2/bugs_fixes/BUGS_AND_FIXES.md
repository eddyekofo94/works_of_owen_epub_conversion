...
**Evidence (v2):** 
- ThML splits Part 2 Chapter 1 and Chapter 2 into four `div1` units: `ch010` (Chap 1), `ch011` (I.), `ch012` (Chap 2), `ch013` (II.).
- PDF Comparison: "I." is a subheading within Chapter 1 (PDF p. 55), and "II." is the opening subheading of Chapter 2 (PDF p. 64).
- Fragmented heads identified: `ch011`, `ch013`, `ch015`, `ch016`, `ch017`, `ch019`, `ch020`, `ch022`, `ch023`, `ch024`, `ch027`, `ch028`, `ch030`, `ch032`, `ch034`.
