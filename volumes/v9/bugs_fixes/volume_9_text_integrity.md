...
- EPUB content tokens: 254523
- Approximate PDF-to-EPUB coverage ratio: 0.9964
- Pages checked: 771
- Weak page matches: 3
...
- page: 60; sample: his goodwill and kindness his patience to us ward and we cannot but be
- page: 73; sample: god herein the apostle includes the whole mystery of his death and blood shedding
...
- file: EPUB/ch006.xhtml; previous: ese words I have long since, in another way, proved, evinced, and applied. 7 There is another proposition lies in the text, and that I shall now apply myself unto, which is this: —; next: Obs. 2. Steadfastness in believing the promises is exceeding acceptable unto God.
...
- file: EPUB/ch007.xhtml; previous: y when any thing in the world might rather be looked for. This, with the use of it, I shall manifest by an induction of some particular promises which are generally known to all: —; next: Isaiah 43:22-26. Here are persons guilty of sundry sinful follies. The Lord chargeth them home upon their consciences, to their trouble and disquietment; he makes them go with woun
- file: EPUB/ch007.xhtml; previous: I shall give one or two instances of this kind: —; next: Isaiah 32:2: Here are four pressures and troubles mentioned, whereunto we may be exposed: — [1.] The wind; [2.] A tempest; [3.] Dearth; [4.] Weariness. And unto all these is the ma
- file: EPUB/ch008.xhtml; previous: This being the design of the Holy Ghost in this place, I shall present it in this one proposition unto you: —; next: That it is an eminent effect and fruit of our reconciliation unto God and among ourselves, by the blood of Christ, that believers enjoy the privileges of the excellent, glorious, s
...
- word: compassionate; epub: 3; tagged: 0
- word: capernaum; epub: 3; tagged: 0
- word: possessor; epub: 3; tagged: 0
