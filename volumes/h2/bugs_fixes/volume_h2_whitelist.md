...
> Current Need: **36.3** | Grade: FULL | QA Level: FULL
...
|---|---|---|---|---|
| **Current state** | 10.0 | 0.0 | 7.6 | **36.3** |
...
7. Verify Need drops from 36.3 to target
...
**Reason:** The 36 split candidates are false positives caused by Owen's quoting convention where a blockquote is introduced on one line (ending in a comma or without terminal punctuation) and the blockquote follows on the next line. The paragraphs are structurally correct and should not be merged.

### `unresolved_citations`
**Reason:** The 39 unresolved citations are primarily obscure patristic references (e.g. `lib. v`, `lib. iii`) for which no standard ThML translation mapping exists. They are accurately transcribed from the original text.

### `repeated_phrases`
**Reason:** The repeated phrases are legitimate treatise/part headings ("part iv concerning the sacerdotal office of christ" and "part v concerning a day of sacred rest") that occur both in the Table of Contents and at the start of their respective sections.
