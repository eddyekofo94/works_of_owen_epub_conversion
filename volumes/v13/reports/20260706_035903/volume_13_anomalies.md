# Text Integrity & Anomaly Audit Report: Volume 13
...
* **Total Words Audited:** 297328
* **Total Suspected Anomalies Found:** 1

Add corrections to `text_replacements` inside `volumes/v13/convert.py` to fix these.
...
### 1. `Obj. 2. "Men are apt to pride themselves in their gifts, and flatter themselves in their performances, so that let them ...`
* **Description:** Paragraph has unmatched double quotes (count: 3)
* **Chapter:** *Chapter 8.*
* **Contexts:**
  * **Obj. 2. "Men are apt to pride themselves in their gifts, and flatter themselves in their performances, so that let them ...**
