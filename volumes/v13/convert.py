...
OVERRIDES = {
    ...
    'text_replacements': {
        ...
        # Aquinas citation repair
        '12. ae. quest. 3. a 1.': '1a 2ae, quest. 3, a. 1.',
        # Fix double quotes read as two single quotes
        "changed.''": 'changed."',
        "destroyed,''": 'destroyed,"',
        '"shekel of the sanctuary.\'\'': '"shekel of the sanctuary."',
        "congregation,''": 'congregation,"',
        '"en herbam.\'\'': '"en herbam."',
        '"Could they make use of our preaching,\'\'': '"Could they make use of our preaching,"',
        '"ordination,\'\'': '"ordination,"',
        "presbyterial.''": 'presbyterial."',
        "government.''": 'government."',
        '"virtue\'\'': '"virtue"',
        '"rules of decency,\'\'': '"rules of decency,"',
        "doctrines''": 'doctrines"',
        '"countermanding\'\'': '"countermanding"',
        '"An Act against Seditious Conventicles\'\'': '"An Act against Seditious Conventicles"',
        # Fix more double quotes / unmatched quotes
        '"ordained ministry\'': '"ordained ministry"',
        '"Scripture;\'\'': '"Scripture;"',
        "governors;''": 'governors;"',
        '"excitaturos?\'': '"excitaturos?"',
        'mouth confession is made unto salvation; but of': 'mouth confession is made unto salvation;" but of',
        ...
        'This work,"\'': 'This work,"',
        'comparing spiritual things with spiritual? As these': 'comparing spiritual things with spiritual"? As these',
        '"Egregiam verb laudem et spolia ampla! [AEn., 4:93.]': '"Egregiam vero laudem et spolia ampla!" [AEn., 4:93.]',
        'pleas of the jus divinum" of episcopacy': 'pleas of the "jus divinum" of episcopacy',
        '"repentance toward God and faith toward our Lord Jesus Christ, neither': '"repentance toward God, and faith toward our Lord Jesus Christ," neither',
        'magistrate may" oblige': 'magistrate may "oblige',
        # OCR typo fixes
