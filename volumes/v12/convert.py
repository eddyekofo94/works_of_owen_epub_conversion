...
<div class="title-line-major">Vindiciae Evangelicae;</div>
<div class="title-connector">Or, the</div>
<div class="title-line-medium">Mystery of the Gospel Vindicated</div>
<div class="title-connector">And</div>
<div class="title-line-medium">Socinianism Examined,</div>
<div class="title-connector">In the Consideration and Refutation of a</div>
<div class="title-line-medium">Catechism,</div>
<div class="title-connector">Published by John Biddle, M.A.;</div>
<div class="title-connector">And the Catechism of Valentinus Smalcius, commonly called</div>
<div class="title-line-medium">The Racovian Catechism;</div>
<div class="title-connector">With the Vindication of the Testimonies of Scripture concerning the Deity and Satisfaction of Jesus Christ from the perverse Expositions and Interpretations of them by Hugo Grotius, in his Annotations on the Bible.</div>
<div class="title-rule" aria-hidden="true"></div>
<div class="quote-block" style="text-align: center; margin: 1.5em auto; max-width: 80%;">
<p lang="el" style="font-family: 'SBL Greek', 'Cardo', serif; font-size: 1.15em; line-height: 1.45; margin-bottom: 0.5em;">Μηδὲ ἐμοὶ τῷ ταῦτα λέγοντι ἁπλῶς πιστεύσῃς, ἐὰν τὴν ἀπόδειξιν τῶν καταγγελλομένων ἀπὸ θείων μὴ λάβῃς γραφῶν</div>
<div class="title-source" style="font-size: 0.9em; margin-top: 0;">— CYRIL, HIEROS., Catech. 4.</div>
<p style="font-size: 0.85em; margin-top: 1em; text-align: justify; text-align-last: center;">[“Believe not even me simply in these things, unless you receive the proof of what I declare from the divine Scriptures.” — Cyril of Jerusalem, <em>Catechetical Lectures</em>, Lecture 4, Section 17, NPNF 2, 7:23; PG 33.476]</div>
</div>
</section>'''

_V12_DEATH_JUSTIFICATION_TITLE_PAGE = '''<section class="treatise-title-page" epub:type="titlepage">
<div class="title-line-medium">Of the Death of Christ,</div>
<div class="title-connector">and of</div>
<div class="title-line-major">Justification:</div>
<div class="title-connector">Being a Full Answer to Mr Richard Baxter's Exceptions</div>
<div class="title-connector">in His Treatise of</div>
<div class="title-line-medium">Redemption.</div>
</section>'''

_V12_GROTIUS_TITLE_PAGE = '''<section class="treatise-title-page" epub:type="titlepage">
<div class="title-line-medium">A Review of the Annotations of</div>
<div class="title-line-major">Hugo Grotius,</div>
<div class="title-connector">in Reference to the Doctrine of the</div>
<div class="title-line-medium">Deity and Satisfaction of Christ.</div>
</section>'''
...
<p class="contents-item"><strong>Chapter I.</strong> <a href="ch007.xhtml">Mr Biddle's first chapter examined — Of the Scriptures</a></p>
<p class="contents-item"><strong>Chapter II.</strong> <a href="ch008.xhtml">Of the nature of God</a></p>
<p class="contents-item"><strong>Chapter III.</strong> <a href="ch009.xhtml">Of the shape and bodily visible figure of God</a></p>
<p class="contents-item"><strong>Chapter IV.</strong> <a href="ch010.xhtml">Of the attribution of passions and affections, anger, fear, repentance, unto God — In what sense it is done in the Scripture</a></p>
<p class="contents-item"><strong>Chapter V.</strong> <a href="ch011.xhtml">Of God's prescience or foreknowledge</a></p>
<p class="contents-item"><strong>Chapter VI.</strong> <a href="ch012.xhtml">Of the creation, and condition of man before and after the fall</a></p>
<p class="contents-item"><strong>Chapter VII.</strong> <a href="ch015.xhtml">Of the person of Jesus Christ, and on what account he is the Son of God</a></p>
<p class="contents-item"><strong>Chapter VIII.</strong> <a href="ch018.xhtml">An entrance into the examination of the Racovian Catechism in the business of the deity of Christ — Their arguments against it answered; and testimonies of the eternity of Christ vindicated</a></p>
<p class="contents-item"><strong>Chapter IX.</strong> <a href="ch019.xhtml">The pre-eternity of Christ farther evinced — Sundry texts of Scripture vindicated</a></p>
<p class="contents-item"><strong>Chapter X.</strong> <a href="ch020.xhtml">Of the names of God given unto Christ</a></p>
<p class="contents-item"><strong>Chapter XI.</strong> <a href="ch021.xhtml">Of the work of creation assigned to Jesus Christ, etc. — The confirmation of his eternal deity from thence</a></p>
<p class="contents-item"><strong>Chapter XII.</strong> <a href="ch022.xhtml">All-ruling and disposing providence assigned unto Christ, and his eternal Godhead thence farther confirmed, with other testimonies thereof</a></p>
<p class="contents-item"><strong>Chapter XIII.</strong> <a href="ch023.xhtml">Of the incarnation of Christ, and his pre-existence thereunto</a></p>
<p class="contents-item"><strong>Chapter XIV.</strong> <a href="ch024.xhtml">Sundry other testimonies given to the deity of Christ vindicated</a></p>
<p class="contents-item"><strong>Chapter XV.</strong> <a href="ch025.xhtml">Of the Holy Ghost, his deity, graces, and operations</a></p>
<p class="contents-item"><strong>Chapter XVI.</strong> <a href="ch028.xhtml">Of salvation by Christ</a></p>
<p class="contents-item"><strong>Chapter XVII.</strong> <a href="ch030.xhtml">Of the mediation of Christ</a></p>
<p class="contents-item"><strong>Chapter XVIII.</strong> <a href="ch031.xhtml">Of Christ's prophetical office</a></p>
<p class="contents-item"><strong>Chapter XIX.</strong> <a href="ch032.xhtml">Of the kingly office of Jesus Christ, and of the worship that is ascribed and due to him</a></p>
<p class="contents-item"><strong>Chapter XX.</strong> <a href="ch033.xhtml">Of the priestly office of Christ — How he was a priest — When he entered on his office — And how he dischargeth it</a></p>
<p class="contents-item"><strong>Chapter XXI.</strong> <a href="ch035.xhtml">Of the death of Christ, the causes, ends, and fruits thereof, with an entrance into the doctrine of his satisfaction thereby</a></p>
<p class="contents-item"><strong>Chapter XXII.</strong> <a href="ch036.xhtml">The several considerations of the death of Christ as to the expiation of our sins thereby, and the satisfaction made therein — First, Of it as a price; secondly, As a sacrifice</a></p>
<p class="contents-item"><strong>Chapter XXIII.</strong> <a href="ch037.xhtml">Of the death of Christ as it was a punishment, and the satisfaction made thereby</a></p>
<p class="contents-item"><strong>Chapter XXIV.</strong> <a href="ch038.xhtml">Some particular testimonies evincing the death of Christ to be a punishment, properly so called</a></p>
<p class="contents-item"><strong>Chapter XXV.</strong> <a href="ch039.xhtml">A digression concerning the 53d chapter of Isaiah, and the vindication of it from the perverse interpretation of HUGO GROTIUS</a></p>
<p class="contents-item"><strong>Chapter XXVI.</strong> <a href="ch040.xhtml">Of the matter of the punishment that Christ underwent, or what he suffered</a></p>
<p class="contents-item"><strong>Chapter XXVII.</strong> <a href="ch041.xhtml">Of the covenant between the Father and the Son, the ground and foundation of this dispensation of Christ’s being punished for us and in our stead</a></p>
<p class="contents-item"><strong>Chapter XXVIII.</strong> <a href="ch042.xhtml">Of redemption by the death of Christ as it was a price or ransom</a></p>
<p class="contents-item"><strong>Chapter XXIX.</strong> <a href="ch043.xhtml">Of reconciliation by the death of Christ as it is a sacrifice</a></p>
<p class="contents-item"><strong>Chapter XXX.</strong> <a href="ch044.xhtml">The satisfaction of Christ, on the consideration of his death being a punishment, farther evinced, and vindicated from the exceptions of Smalcius</a></p>
<p class="contents-item"><strong>Chapter XXXI.</strong> <a href="ch045.xhtml">Of election and universal grace — Of the resurrection of Christ from the dead</a></p>
<p class="contents-item"><strong>Chapter XXXII.</strong> <a href="ch046.xhtml">Of justification and faith</a></p>
<p class="contents-item"><strong>Chapter XXXIII.</strong> <a href="ch047.xhtml">Of keeping the commandments of God, and of perfection of obedience — How attainable in this life</a></p>
<p class="contents-item"><strong>Chapter XXXIV.</strong> <a href="ch048.xhtml">Of prayer; and whether Christ prescribed a form of prayer to be used by believers; and of praying unto him and in his name under the old testament</a></p>
<p class="contents-item"><strong>Chapter XXXV.</strong> <a href="ch049.xhtml">Of the resurrection of the dead and the state of the wicked at the last day</a></p>
...
OVERRIDES = {
    ...
    'text_replacements': {
        ...
        "ejus ;": "ejus;",
        "est ,": "est,",
        "h/s subsisting": "his subsisting",
        "abest, b si": "abest, si",
        "even u the": "even the",
        "allo w him": "allow him",
        "kne w him": "knew him",
        "delivered b from": "delivered from",
        "Mr B hath": "Mr B. hath",
        "seal et": "sed et",
    },
    'regex_replacements': {
        ...
        r'h/s subsisting': 'his subsisting',
        r'at\s*\]east': 'at least',
        r'\[f187\] b si sit prudentia: nos to,': '[f187] si sit prudentia: nos te,',
        r'\[f384\] b from': '[f384] from',
        r'yet\s*\]mow': 'yet know',
