...
# Define substrings and their proposed translations
items = [
    ...
    ("Philadelphians [cap. 2]: Οπου ὁ ποιμήν ἐστιν ἐκεῖ ὡς πρόβατα ἀκολουθεῖτε", "Ignatius, <i>Epistula ad Philadelphenses</i>, 2: \"Οπου ὁ ποιμήν ἐστιν ἐκεῖ ὡς πρόβατα ἀκολουθεῖτε\"."),
    ("[cap.4]: Θαῤῥῶν γράφω τῂ ἀξιοθέῳ ἀγάπῃ ὑμῶν παρακαλῶν ὑμᾶς μηδὲν κατ' ἐρίθειαν πράσσειν", "Ignatius, <i>Epistula ad Philadelphenses</i>, 8: \"Θαῤῥῶν γράφω τῂ ἀξιοθέῳ ἀγάπῃ ὑμῶν παρακαλῶν ὑμᾶς μηδὲν κατ' ἐρίθειαν πράσσειν\"."),
    ("[cap. 10]: Πρέπον ἐστὶν ὑμῖν ὡς ἐκκλησίᾳ Θεοῦ χειροτονῆσαι διάκονον", "Ignatius, <i>Epistula ad Philadelphenses</i>, 10: \"Πρέπον ἐστὶν ὑμῖν ὡς ἐκκλησίᾳ Θεοῦ χειροτονῆσαι διάκονον\"."),
    ("[cap. 5]: Εἰ γὰρ ἑνὸς καὶ δευτέρου προσευχὴ τοσαύτην ἱσχὺν ἔχει", "Ignatius, <i>Epistula ad Ephesios</i>, 5: \"Εἰ γὰρ ἑνὸς καὶ δευτέρου προσευχὴ τοσαύτην ἱσχὺν ἔχει\"."),
    ("[cap. 13]: Σπουδάζετε οῦν πυκνότερον συνέρχεσθαι ὅταν γὰρ", "Ignatius, <i>Epistula ad Ephesios</i>, 13: \"Σπουδάζετε οῦν πυκνότερον συνέρχεσθαι ὅταν γὰρ\"."),
    ...
    ("Tertullian in his Algol, and lib. 2 ad Uxor. et de cultu foeminarum;", "Tertullian, <i>Apologeticus</i>, and <i>Ad Uxorem</i> 2, and <i>De Cultu Feminarum</i>;"),
    ...
    ("Sozomen tells you expressly that he did so, lib. 4 cap. 15;", "Sozomen, <i>Historia Ecclesiastica</i>, 4.15;"),
...
d = {}
for sub, trans in items:
    if sub not in text:
        print(f"NOT FOUND: '{sub}'")
    else:
        d[sub] = f"<b>Modern Citation:</b> {trans}"
