...
**The Rule:** When styling the superscript footnote numbers within the main body text, you **must** use `display: inline-block !important;`.
By default, hyperlink tags (`<a>`) are `display: inline`. E-readers often ignore horizontal spacing on purely inline elements, causing the footnote number to collide with the preceding word. `inline-block` forces WebKit to respect horizontal margins without disrupting the line height.
...
a[epub\:type="noteref"], .noteref {
    ...
    font-size: 0.70rem;
    line-height: 0;
    padding: 0.1em 0.15em; /* Expanding touch target for mobile */
    margin-left: 0.25em !important; /* Pushes the number away from preceding word */
    white-space: nowrap;
}
```
